...
import { SearchDtoToGalleryDataMapper } from "./SearchDtoToGalleryDataMapper";
...
describe("ISearch to IGalleryData", () => {
  test("should parse SearchDto to GalleryData", () => {
    const data:IGalleryData = SearchDtoToGalleryDataMapper(mock)

    expect(data).toEqual(mockParsed)
  });
});
